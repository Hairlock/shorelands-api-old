...
Elm.TextReverser = Elm.TextReverser || {};
Elm.TextReverser.make = function (_elm) {
   "use strict";
   _elm.TextReverser = _elm.TextReverser || {};
   if (_elm.TextReverser.values)
   return _elm.TextReverser.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TextReverser",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var myStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                     ...
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "text-align"
                                                      ,_1: "center"}]));
   var stringInput = function (string) {
   ...
   var reversedString = function (string) {
      ...
      _L.fromArray([$Html.text($String.reverse(string))]));
   };
   var view = function (string) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([stringInput(string)
                   ,reversedString(string)]));
   };
   var main = A2($Signal.map,
   view,
   actions.signal);
   _elm.TextReverser.values = {_op: _op
                              ,view: view
