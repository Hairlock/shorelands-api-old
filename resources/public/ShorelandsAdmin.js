...
Elm.ShorelandsAdmin = Elm.ShorelandsAdmin || {};
Elm.ShorelandsAdmin.make = function (_elm) {
   "use strict";
   _elm.ShorelandsAdmin = _elm.ShorelandsAdmin || {};
   if (_elm.ShorelandsAdmin.values)
   return _elm.ShorelandsAdmin.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ShorelandsAdmin",
   $Basics = Elm.Basics.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var main = $Html.text("Shorelands Admin");
   _elm.ShorelandsAdmin.values = {_op: _op
                                 ,main: main};
   return _elm.ShorelandsAdmin.values;
};
