...
Elm.Main.make = function (_elm) {
   ...
   var size = $Signal.map(function (t) {
      return $Basics.round(200 + 100 * $Basics.sin($Basics.degrees(t) / 10));
   })(A2($Signal.foldp,
   F2(function (x,y) {
      return x + y;
   }),
   ...
   var view = function (n) {
      return A2($Html.img,
      _L.fromArray([$Html$Attributes.src("http://elm-lang.org/imgs/yogi.jpg")
